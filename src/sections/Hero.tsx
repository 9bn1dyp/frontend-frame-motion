...
export const Hero = () => {
  ...
  return (
    <section ref={heroRef} className='pt-8 pb-20 md:pt-5 md:pb-10 bg-[radial-gradient(ellipse_200%_100%_at_bottom_left,#183EC2,#EAEEFE_70%)] overflow-x-clip'>
      <div className="container">
        ...
        <div className='md:flex items-center'>
          ...
          <div className='mt-20 md:mt-0 md:h-[648px] md:flex-1 relative'>
            ...
            height={220} 
            alt='Cyclinder image' 
            className='hidden md:block -top-6 -left-32 md:absolute'
            style={{
            ...
            src={noodleImage.src} 
            width={220} 
            className='hidden lg:block absolute top-[550px] left-[448px] rotate-[30deg]' alt='Noodle image'
            style={{
              rotate: 30,
              translateY: translateY,
            }}/>          
